                ...
                >
                    ...
                    >
                        ...
                        <div className='flex items-center gap-4 px-2 mt-2'>
                            <label htmlFor='supply-status-in' className='flex items-center gap-2 theme-label text-sm'>
                                <input
                                    id='supply-status-in'
                                    name='supplyStatus'
                                    value='true'
                            ...
                            <label htmlFor='supply-status-out' className='flex items-center gap-2 theme-label text-sm'>
                                <input
